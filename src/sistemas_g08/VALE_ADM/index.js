...
const ValeAdm = ()  =>{
    ...
    async function updatePlaceHolder(){
        await api.get('/objeto_test/vale_adm',{headers: {'Content-Type': 'application/json'}}).then(t=>{
    ...
    async function handleSubmit(){
        ...
        // try{
         ...
         await api.post('/objeto_test',{sistema:'vale_adm', Objeto:JSON.parse(enter)}, {headers: {'Content-Type': 'application/json'}}).then().catch((err)=>{
            console.log(err);
        });
